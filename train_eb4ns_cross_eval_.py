...
parser.add_argument('--img-size', type=int, default=512, metavar='N',
...
parser.add_argument('--output', default='TFEB4NS-MIXUP-MIXCUTUP-CROSSVAL-MERGEDATA-LR003-V2', type=str, metavar='PATH',
    ...
    try:
        for epoch in range(start_epoch, num_epochs):
            ...
            if vis is not None:
                ...
                vis.plot_curves({'val acc1': float(eval_metrics['top1'])}, iters=epoch, title='val acc1',xlabel='iters', ylabel='val acc1')
